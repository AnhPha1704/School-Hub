...
const EventCalendar = () => {
  ...
  return (
    <div className="bg-white p-4 rounded-2xl border-1 border-gray-200">
      <Calendar locale="vi-VN" onChange={onChange} value={value} />
      ...
      <div className="flex flex-col gap-4">
        {events.map((event) => (
          <div
            className="p-5 rounded-md border-2 border-gray-100 border-t-4 odd:border-t-[var(--color-greenLight)] even:border-t-[var(--color-yellowLight)]"
            key={event.id}
          >
            <div className="flex items-center justify-between">
