...
export const calendarEvents = [
  // Thứ Hai - 10/11/2025
  {
    ...
    end: new Date(2025, 10, 10, 8, 45),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2025, 10, 10, 9, 0),
    end: new Date(2025, 10, 10, 9, 45),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2025, 10, 10, 10, 0),
    end: new Date(2025, 10, 10, 10, 45),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(2025, 10, 10, 11, 0),
    end: new Date(2025, 10, 10, 11, 45),
  },
  {
    title: "Chemistry",
    allDay: false,
    start: new Date(2025, 10, 10, 13, 0),
    end: new Date(2025, 10, 10, 13, 45),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(2025, 10, 10, 14, 0),
    end: new Date(2025, 10, 10, 14, 45),
  },

  // Thứ Ba - 11/11/2025 (hôm nay)
  {
    title: "English",
    allDay: false,
